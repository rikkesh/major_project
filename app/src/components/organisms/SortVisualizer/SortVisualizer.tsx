...
import VisualizerControls from '../../molecules/VisualizerControls/VisualizerControls';
...
class SortVisualizer extends Component<SortVisualizerProps, SortVisualizerState> {
  ...
  _changeVisualState = (visualState: any) => {
    this.setState({
      ...
      let timeoutId = setTimeout(
        (item) => {
          this.setState(
            ...
            () => this._changeVisualState(item) // Corrected line
          );
        },
        i * timer,
        item
    ...
    return (
      <div className="SortVisualizer">
        ...
        <VisualizerControls
          ...
          playDisabled={
            (this.state.traceStep >= this.state.trace.length - 1 && this.state.traceStep !== -1) ||
            this.state.trace.length <= 0
          }
