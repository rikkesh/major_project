...
const Sort = () => {
    ...
    let [question,setQuestion] =useState(sort[index]);
  ...
  return (
    <Wrapper>
      <div className='container'>
        ...
        <div className='index'>{index+1} of {sort.length} questions</div>
        </>}
        {result?<><h2>You Scored {score} out of {sort.length}</h2>
